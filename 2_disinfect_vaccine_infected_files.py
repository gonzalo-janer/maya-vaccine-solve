...
def get_ma_infected_files():
    try:
        ...
        print('Please run: "1_list_vaccine_infected_files.py" before running this script.')
        exit()
...
def disinfect_ma_files(ma_infected_file_list):
    infected_file_num = len(ma_infected_file_list)
    print('DISINFECTING', infected_file_num, 'FILES:')
    ...
    for ma_file in ma_infected_file_list:
        ...
        disinfected_count += 1
        print("DISINFECTED:", disinfected_count, '/', infected_file_num, ma_file_name)
    print('\nTHE ABOVE LISTED .ma FILES HAVE BEEN BACKED UP AND DISINFECTED\n')
    print('TOTAL DISINFECTED FILES =', disinfected_count)
