...
def get_infected_files(ma_file_list):
    ...
    infected_count = 0
    file_count = 0
    total_ma_files = len(ma_file_list)
    for ma_file in ma_file_list:
        file_count += 1
        infected = False
        print('  -scanning', file_count, '/', total_ma_files, ma_file)
